...
/// <summary>
/// Use case for retrieving fixed MIDI CC assignments from a System Dump.
/// </summary>
public interface IGetCCMappingsUseCase
{
    /// <summary>
    /// Gets all fixed MIDI CC assignments from the provided System Dump.
    /// </summary>
    /// <param name="systemDump">The System Dump to extract CC assignments from.</param>
