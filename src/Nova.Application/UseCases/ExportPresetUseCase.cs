...
public sealed class ExportPresetUseCase
{
    ...
    private string BuildTextContent(Preset preset)
    {
        var lines = new List<string>
        {
            ...
            $"Map Parameter: {preset.MapParameter}",
            $"Map Min: {preset.MapMin}",
            $"Map Mid: {preset.MapMid}",
            $"Map Max: {preset.MapMax}",
            "",
            "# === EFFECT SWITCHES ===",
            ...
            $"Gate Enabled: {preset.GateEnabled}",
            $"Pitch Enabled: {preset.PitchEnabled}",
            "",
            "# === COMPRESSOR ===",
            ...
            $"Drive Tone: {preset.DriveTone}",
            $"Drive Level: {preset.DriveLevel}",
            "",
            "# === BOOST ===",
            $"Boost Level: {preset.BoostLevel}",
            $"Boost Enabled: {preset.BoostEnabled}",
            "",
            "# === MODULATION ===",
            ...
            $"Delay Offset Or Pan1: {preset.DelayOffsetOrPan1}",
            $"Delay Sense Or Pan2: {preset.DelaySenseOrPan2}",
            $"Delay Damp: {preset.DelayDamp}",
            $"Delay Release: {preset.DelayRelease}",
            ...
            $"Pitch Direction: {preset.PitchDirection}",
            $"Pitch Range: {preset.PitchRange}",
            $"Pitch Mix: {preset.PitchMix}"
        };
